...
class DDS_Frequency_3(ConductorParameter):
    """ 
    ...
    def update(self):
        if self.value is not None:
            ...
            print('AD9914 frequency 3:', out_freq)
            self.cxn.yesr14_ad9914.clear_programmable_modulus_mode()
            self.cxn.yesr14_ad9914.save_new_frequency(3, out_freq)

 
Parameter = DDS_Frequency_3
