...
import json
class DDS_Frequency_2(ConductorParameter):
    """ 
...
#            mjm_comb_demod = 175590592.0 # quick hack without reading out values from si21 server
            ...
            print('AD9914 frequency 2:', final_value)
            self.cxn.yesr14_ad9914.save_new_frequency(2, final_value)


 
Parameter = DDS_Frequency_2
