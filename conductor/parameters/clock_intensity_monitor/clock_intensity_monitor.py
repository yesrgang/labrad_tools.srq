        ...
        if len(intersection) > 0:
            try:
                if model.value == 5000:
                    ...
                    self.cxn.yegollum_picoscope.set_recordduration_5000a(duration.value,presamples.value,postsamples.value)
                    #self.cxn.yesr13_picoscope.get_data_5000a(self.value,serial_no.value)
                    self.cxn.yegollum_picoscope.get_data_5000a(self.value,serial_no.value)
                    ...
                    self.cxn.yegollum_picoscope.set_recordduration_3000a(duration.value,presamples.value,postsamples.value)
                    #self.cxn.yesr13_picoscope.get_data_3000a(self.value,serial_no.value)
                    self.cxn.yegollum_picoscope.get_data_3000a(self.value,serial_no.value)
                ...
                print('yegollum_picoscope error! Check conductor parameter and enable error output in "clock_intensity_monitor" for details')
                print(e)
