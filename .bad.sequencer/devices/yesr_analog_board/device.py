...
class YeSrAnalogBoard(YeSrSequencerBoard):
    ...
    okfpga_bitfilename = 'analog_sequencer-v3.1.bit'
    ...
    def update_channel_modes(self):
        ...
        value = 0b1000000000000000 | value
        self.okfpga_server.set_wire_in_value(self.okfpga_interface, self.channel_mode_wire, value)
    ...
    def update_channel_manual_outputs(self): 
        for c, w in zip(self.channels, self.manual_voltage_wires):
            ...
            self.okfpga_server.set_wire_in_value(self.okfpga_interface, w, v)
        self.okfpga_server.update_wire_ins(self.okfpga_interface)
