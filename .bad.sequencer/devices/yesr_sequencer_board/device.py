...
class YeSrSequencerBoard(DefaultDevice):
    ...
    okfpga_servername = None
    okfpga_interface = None
    okfpga_bitfilename = None
    ...
    def initialize(self, config):
        ...
        self.okfpga_server = self.cxn[self.okfpga_servername]
        self.okfpga_server.configure_fpga(
                self.okfpga_interface, self.okfpga_bitfilename)
        self.update_mode()
    ...
    def set_raw_sequence(self, raw_sequence):
        ...
        self.okfpga_server.write_to_pipe_in(
                self.okfpga_interface, self.sequence_pipe, self.sequence_bytes)
    ...
    def update_mode(self):
        ...
        self.okfpga_server.set_wire_in_value(self.okfpga_interface, self.mode_wire, mode_word)
        self.okfpga_server.update_wire_ins(self.okfpga_interface)
