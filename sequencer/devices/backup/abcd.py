...
#        ]
    channels = [
        ...
        YeSrDigitalChannel(loc=['C', 7], name='V Clock Switch', mode='manual', manual_output=False, invert=False),
        ...
        YeSrDigitalChannel(loc=['D', 12], name='TTLD12', mode='manual', manual_output=False, invert=False),
